...
Go to configurations, then on left (or right) side of page
...
+)  In Spree v.1.3.2-beta, tax is displayed in the cart. At this time that
    is not updated if returning to cart after initiating checkout process.
